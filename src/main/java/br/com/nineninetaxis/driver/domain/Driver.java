 ...
 */
@Entity
@Table(uniqueConstraints = {@UniqueConstraint(name = Driver.CONSTRAINT_NAME, columnNames = {"name", "plate"})})
public class Driver {

    public static final String CONSTRAINT_NAME = "unique_name_plate";
